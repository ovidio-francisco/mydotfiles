...
echo ""
screenfetch && fortune | cowsay && echo ""

jufscar() { 
    echo "  jumping to UFSCar"
    echo ""
    
    cd /ext4Data/UFSCar

    tput bold
    echo "  we are in the UFSCar folder"
    tput sgr0 
...
# alias rm='rm -i'
alias rm='echo "don'"'"'t use this shit! - try del"'
alias del='trash-put'
